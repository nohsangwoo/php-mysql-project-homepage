...
<html lang="ko">
  ...
  <body class="kosugio_font">
    ...
    if($user_id==null || $post_id == null ){   //비로그인 상태에서 접근 불가 || 이전 단계에서 값을 받아오지 못하면 접근불가
    ...
    <div class="container" style="margin-top: 30px;">  <!--name으로 전달값 식별-->
      <form class="" action="./my_update_pw_phase_of_update_process.php" method="post" onsubmit="return validate();">
