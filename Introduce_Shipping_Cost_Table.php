...
<html lang="ko">
  <head>
    ...
    <link rel= "stylesheet" type="text/css" href="./css/shipping_cost.css">
  ...
  <body class="kosugio_font">
    ...
    //shpping_const_contents
    require("./Introduce_Shipping_Cost_Table_Contents.php");
