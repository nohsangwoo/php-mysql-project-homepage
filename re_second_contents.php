...
$post_pk = (isset($_POST['pk'])) ? strip_tags(htmlspecialchars($_POST['pk'])) : NULL ; //2차견적시 넘어오는 pk값

//
// $get_parameter = (isset($_GET['para'])) ? $_GET['para'] : NULL ; //2차견적안내 맨처음 접속시 넘어오는 pk값
...
// var_dump($get_parameter);
 ...
 ?>
    ...
    <div class="container EE_contents">
      <div class="">
        <p>
          <form  action="re_second.php" method="post" enctype="multipart/form-data" >
            <div class="form-row">
    ...
    <form class="" action="re_second_contents_process.php" method="post">

      <input type="hidden" name="pk" value="<?php echo $post_pk;?>"> <!--pk-->
      <input type="hidden" name="weight" value="<?php echo $weight;?>"> <!--무게-->
      <input type="hidden" name="exchange_rate" value="<?php echo $exchange_rate;?>"> <!--환율-->
