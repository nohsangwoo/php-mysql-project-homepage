...
<html lang="ko">
  ...
  <body class="kosugio_font">
    ...
    if($user_id || $post_id==null){   //로그인상태로 접근했을때 거부
    ...
    <script>
     function chid(){ //인증번호 확인
      ...
      ifrm1.location.href="my_forgot_pw_phase_of_verify_chk.php?email=" + id + "&verify=" + verify;  //해당 페이지로 get방식으로보냄
     }
    </script>
    ...
    <div class="container" style="margin-top: 30px;">  <!--name으로 전달값 식별-->
      <form class="" action="./my_forgot_pw_phase_of_update.php" method="post" onsubmit="return validate();">
