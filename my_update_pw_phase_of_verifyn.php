...
<html lang="en" dir="ltr">
  ...
  <body class="kosugio_font">
    ...
    if($user_id==null){   //비로그인 상태에서 접근 불가
    ...
    $post_id = strip_tags(htmlspecialchars($post_id));
    ...
    function generateRandomString($length) {
     ...
     <form class="" name="hiddenForm" action="./my_update_pw_phase_of_verify.php" method="post">
