...
<html lang="ko">
  ...
  <body class="kosugio_font">
    ...
    require("./re_ordered_content_first.php");//1차 비용 안내 내용


    require("re_ordered_content_delivery_price.php");//2차 비용 안내 내용


    require("./re_ordered_content_second.php");//2차 배송을 위한 고객의 정보 내용
