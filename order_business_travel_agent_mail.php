...
<form class="row" name="form" action="./order_agent_mail_send.php" method="post" enctype="multipart/form-data">
  ...
  <div class="row col-12"  id="urlList3">
    ...
    <button class="col btn btn-primary"style="margin-left:15px; " type="button" onclick="urlBTN3();"  name="button" >+</button>
...
function urlBTN3() {
  $("#urlList3").append(`<input class="form-control form-control contact_string col-12" name ="url[]" type="text" placeholder="http://(製品のurl)"  autocomplete="off" style="margin-top:3px;">`); //id가 chat태그 하위 내용으로 이내용을 추가한다
}
