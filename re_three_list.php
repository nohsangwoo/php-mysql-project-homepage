...
<html lang="ko">
  ...
  <body class="kosugio_font">
    ...
    <p><h1>3 - 한국내 배송완료(2차결제 입금대기중)</h1></p>
    <p>(집으로 물건이 온후 2차결제 안내를 한후 체크)</p>
    <p><a href="http://ffss.kr/second_payment.php" target="_blank">http://ffss.kr/second_payment.php</a></p>

    <a href="https://mail.google.com/mail/u/0/#inbox" target= "_blank">2차결제 안내하러 가기</a>
...
<?php
     ...
     $state="3"; //한국내 배송완료(2차결제 입금대기중) - 집으로 물건이 온후 2차결제 안내를 한후 체크

     require("./re_zero_to_five_contents.php");
