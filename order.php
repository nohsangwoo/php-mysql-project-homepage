...
<html lang="ko">
  <head>
    ...
    <link rel= "stylesheet" type="text/css" href="./css/Word_Color.css">
   ...
   <!--recaptcha v3-->
    ...
    grecaptcha.ready(function() {
        grecaptcha.execute('6LeDu40UAAAAAO55BdgSxDUEkr5OJYbWQmVe9DVk', {action: 'homepage'}).then(function(token) {
